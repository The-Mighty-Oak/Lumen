          ...
          <div className={styles.layoutSec}>
            <Layout>
              <div className={styles.posts}>
                {data.postsConnection.edges.map((post) => <div className={styles.postsCard}><PostCard post={post.node} key={post.platform} /> </div>)} 
              </div>
            </Layout>
          </div>
        </div>
        ...
        <div className={styles.footerSectionWrapper}>
          <div className={styles.socialsSectionWrapper}>
            ...
            <div className={styles.socialLinksWrapper}>
              {data.socialsConnection.edges.map((social) => <div className={styles.socialLinks}><Socials social={social.node} key={social.title} /> </div>)} 
            </div>
            <hr />
          </div>
          <Footer />
