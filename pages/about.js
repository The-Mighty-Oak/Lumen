    ...
    <div>
      ...
      <div className={styles.aboutSectionContainer}>
        <div className={styles.aboutSection}>
          {socials.aboutLumen_Connection.edges.map((about) => <div className={styles.socialLinks}><AboutDetails about={about.node} key={about.title} /> </div>)}
        </div>
        ...
        <div className={styles.writersSection}>
          ...
          <div className={styles.writers}>
            {socials.authorsConnection.edges.map((writer) => <div className={styles.writerInfo}><AuthorDetails writer={writer.node} key={writer.title} /> </div>)}
          </div>
        </div>
      </div>
